...
class HistoricalBar(Base):
    ...
    timeframe_minutes = Column(Integer, primary_key=True, nullable=False, default=1)  # Timeframe en minutos
...
class Account(Base):
    ...
    id = Column(String(50), primary_key=True)  # ID de TopstepX
    name = Column(String(200), nullable=False)
    balance = Column(Float, nullable=False, default=0.0)
    can_trade = Column(Boolean, nullable=False, default=False, index=True)
    simulated = Column(Boolean, nullable=False, default=True)
    is_active = Column(Boolean, nullable=False, default=True, index=True)  # Si está siendo monitoreada
...
class ContractIndicatorConfig(Base):
    ...
    smi_oversold = Column(Float, nullable=False, default=-40.0)
    smi_overbought = Column(Float, nullable=False, default=40.0)
    ...
    stoch_rsi_oversold = Column(Float, nullable=False, default=20.0)
    stoch_rsi_overbought = Column(Float, nullable=False, default=80.0)
